...
description: "Learn how to authenticate your requests to the NeetoAuth API using API keys."
---

### Generating an API Key

To use the NeetoAuth APIs, you must first generate an API key.
[Learn how to generate your API key here.](https://help.neetoauth.com/articles/api-keys)
...
```bash
curl https://{your-subdomain}.neetoauth.com/api/external/v2/example-endpoint \
