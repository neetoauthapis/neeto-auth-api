...
```bash cURL
curl --request GET \
  --url "https://{your-subdomain}.neetoauth.com/api/external/v2/team-members?page_number=2&page_size=25" \
  --header 'X-Api-Key: your-api-key'
```

```javascript JavaScript
const response = await fetch(
  "https://{your-subdomain}.neetoauth.com/api/external/v2/team-members?page_number=2&page_size=25",
  {
    method: "GET",
    headers: {
...
url = "https://{your-subdomain}.neetoauth.com/api/external/v2/team-members"
params = {
    "page_number": 2,
    "page_size": 25
}
