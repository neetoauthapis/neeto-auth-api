---
title: "Pagination"
description: "Learn how to handle paginated responses in the NeetoAuth API."
---
...
```bash cURL
curl --request GET \
  --url "https://{your-subdomain}.neetoauth.com/api/external/v2/users?page_number=2&page_size=25" \
  --header 'X-Api-Key: your-api-key'
```

```javascript JavaScript
const response = await fetch(
  "https://{your-subdomain}.neetoauth.com/api/external/v2/users?page_number=2&page_size=25",
  {
    method: "GET",
    headers: {
...
url = "https://{your-subdomain}.neetoauth.com/api/external/v2/users"
params = {
    "page_number": 2,
    "page_size": 25
}
...
This retrieves the second page of users, with 25 results per page.
