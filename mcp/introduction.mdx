...
An OAuth connection acts as you and sees what you see. An API key acts as the workspace and sees everything in it. Every supported client can sign in over OAuth, so a key is needed only when you want that workspace-wide reach.
