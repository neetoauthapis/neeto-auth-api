...
const commandPathParts = (command) => command.replace(/^neetoauth\s+/, "").split(/\s+/);
...
const groupToPage = {
  "neetoauth products": "/cli-reference/products",
  "neetoauth users": "/cli-reference/users",
};
...
const overviewSection = (group) => {
  ...
  const title = group.command.replace(/^neetoauth\s+/, "");
