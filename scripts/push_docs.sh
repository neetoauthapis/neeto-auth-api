...
readonly TARGET_REPOSITORY="neetoauthapis/neeto-auth-api"
readonly TARGET_BRANCH="main"
readonly TARGET_URL="https://github.com/${TARGET_REPOSITORY}.git"
readonly DOCUMENTATION_URL="https://apidocs.neetoauth.com/getting-started/introduction"
...
repo_root=$(git rev-parse --show-toplevel 2>/dev/null) || {
  echo "Run this command from the neeto-auth-api repository." >&2
  exit 1
}
